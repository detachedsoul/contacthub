...
const Footer = () => {
	...
	return (
		<footer className="flex items-center justify-between gap-4 px-3.5 pb-4 w-full md:pb-1 sm:w-4/5 sm:left-[10%] lg:left-[25%] lg:w-1/2 sm:mx-auto fixed bottom-0 bg-brand-black/70 backdrop-blur text-brand-white z-50">
			{links.map((link) => (
				<Link
