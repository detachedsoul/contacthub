    ...
    return (
        <section className="space-y-4">
            <div className="rounded-2xl bg-gray-900 p-4 space-y-8">
                ...
                <button className="inline-flex items-center gap-2 rounded-full py-2 px-4 border border-gray-300 hover:bg-lime-500 hover:text-white hover:border-lime-500 transition-colors duration-300 ease-in-out" type="button">
            ...
            <p className="text-sm">
                You can also earn more points by adding friends. You get 5 points for every friend you add
            </p>
